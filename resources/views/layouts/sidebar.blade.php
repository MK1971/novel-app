...
--}}
<aside
    class="novel-reader-focus-hide hidden md:flex md:flex-col fixed left-0 z-30 overflow-y-auto border-r border-amber-200/60 dark:border-stone-700 bg-white/50 dark:bg-stone-900/60 backdrop-blur-sm"
