            ...
            <nav class="sticky top-0 z-50 bg-white/10 backdrop-blur-xl border-b border-white/10">
                <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center gap-8">
                        <a href="{{ route('chapters.index', ['resume' => 1]) }}" class="text-sm font-bold text-white/60 hover:text-white transition-colors">Chapters</a>
                    ...
                    <div class="grid lg:grid-cols-2 gap-16 items-center">
                        <div class="text-left">
                            ...
                            <div class="flex flex-col sm:flex-row items-center gap-6">
                                <a href="{{ route('chapters.index', ['resume' => 1]) }}" class="w-full sm:w-auto px-10 py-5 bg-amber-500 text-black text-lg font-black rounded-2xl hover:bg-amber-600 transition-all shadow-2xl shadow-amber-500/30 transform hover:-translate-y-1">
