...
$classes = ($active ?? false)
            ? 'flex items-center px-4 py-2.5 text-sm font-bold text-amber-900 bg-amber-100 rounded-xl transition-all shadow-sm shadow-amber-500/10'
            : 'flex items-center px-4 py-2.5 text-sm font-bold text-amber-900/60 hover:text-amber-900 hover:bg-amber-50 rounded-xl transition-all group';
...
<a {{ $attributes->merge(['class' => $classes]) }}>
    <svg class="w-5 h-5 mr-3 {{ ($active ?? false) ? 'text-amber-600' : 'opacity-50 group-hover:opacity-100' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
